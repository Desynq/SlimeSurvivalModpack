...
new MarketableItem("melon", "minecraft:melon")
	.setSellPrice(0.10)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(2500)
	.register();

new MarketableItem("pumpkin", "minecraft:pumpkin")
	.setSellPrice(1.00)
	.setCompoundingRate(0.5)
...
// farming (processed)
new MarketableItem("sugar", "minecraft:sugar")
	.setSellPrice(1.00)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(2500)
	.register();

new MarketableItem("green_dye", "minecraft:green_dye")
	.setSellPrice(2.50)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(1000)
	.register();
...
new MarketableItem("nether_star", "minecraft:nether_star")
	.setSellPrice(2500.00)
	.register();

new MarketableItem("blaze_powder", "minecraft:blaze_powder")
	.setSellPrice(5.00)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(250)
	.register();
...
new MarketableItem("phantom_membrane", "minecraft:phantom_membrane")
	.setSellPrice(20.00)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(128)
	.register();

new MarketableItem("bone_meal", "minecraft:bone_meal")
	.setSellPrice(0.50)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(512)
	.register();

new MarketableItem("rotten_flesh", "minecraft:rotten_flesh")
	.setSellPrice(0.50)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(512)
	.register();

new MarketableItem("string", "minecraft:string")
	.setSellPrice(1.00)
	.setCompoundingRate(0.5)
	.setCompoundingPeriod(512)
	.register();
